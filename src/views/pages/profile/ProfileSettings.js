...
import { Button, Row, Col, Card, Nav, Form, Dropdown, NavLink } from 'react-bootstrap';
  ...
  return (
    <Nav className="flex-column">
      ...
      <div className="mb-2">
        ...
        <div>
          <NavLink className="px-0 pt-1" href="/forgot-password" >
            <i className="me-2 sw-3 d-inline-block" />
            <span className="align-middle" >Reset Password</span>
          </NavLink>
          <Nav.Link className="px-0 pt-1" href="/updatepassword">
            <i className="me-2 sw-3 d-inline-block" />
