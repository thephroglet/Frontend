...
const ChartCustomLegendBar = (props) => {
                ...
                >
                  <div className="pe-2">
                    <div
                      ...
                      className="icon-container  sw-1 sh-1 rounded-xl d-flex justify-content-center align-items-center"
                    >
  ...
  const data = React.useMemo(() => {
    return {
      ...
      datasets:props.chartData.map(v => 
        {
          v.backgroundColor= `rgba(${themeValues.primaryrgb},0.1)`,
          v.borderColor= themeValues.primary,
          v.barPercentage=0.8,
          v.borderSkipped= 'bottom',
          v.borderWidth=1.5,
          v.borderRadius= parseInt(themeValues.borderRadiusMd, 10)
          return v
        }) 
     };
  }, [themeValues]);
