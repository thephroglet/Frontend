        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink to="/default" className="heading stretched-link d-block">
                  Default
                </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink to="/visual" className="heading stretched-link d-block">
                  Visual
                </NavLink>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body className="row gx-4">
              ...
              <Col>
                <NavLink to="/analytic" className="heading stretched-link d-block">
                  Analytic
                </NavLink>
